...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 relative">
      <div className="w-full max-w-[650px] flex flex-col justify-center items-center border rounded-[24px] sm:rounded-[49px] shadow-md px-4 sm:px-8 md:px-[80px] py-8 sm:py-10 bg-gradient-main z-20 relative sm:mt-[30px] md:mb-[110px]">
        <div className="flex justify-center items-center gap-4 sm:gap-6 mt-0 sm:mt-5 mb-5">
        ...
        <input
          ...
          className="w-full h-[54px] sm:h-[64px] bg-secondary rounded-full mt-[10px] px-4 sm:p-7 text-base sm:text-xl"
          {...register("first_name")}
        />
        {errors.first_name && (
        ...
        <button
          ...
          className="bg-primary text-white text-base sm:text-lg font-bold rounded-full w-full h-[42px] sm:h-[48px] mt-6 sm:mt-[24px]"
        >
