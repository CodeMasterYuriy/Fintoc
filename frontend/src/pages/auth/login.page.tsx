...
const LoginPage = () => {
  ...
  return (
    <div className="">
      <button
        onClick={() => navigate('/')}
        className="absolute top-8 sm:left-8 left-2 z-50 p-4 cursor-pointer text-primary hover:underline bg-white"
      >
        Volver a Inicio
      </button>
        ...
        <div className="w-full max-w-[700px] flex flex-col justify-center items-center mb-[100px] border rounded-[24px] sm:rounded-[49px] shadow-md px-4 sm:px-8 md:px-[80px] py-8 sm:py-3 bg-white z-20 relative sm:mt-[50px] sm:mb-[140px]">
          ...
          <div className="relative w-full">
            ...
            <button
              ...
              className="absolute right-5 top-[65%] -translate-y-1/2 text-gray-600 focus:outline-none"
            >
              {showConfirmPassword ? (
