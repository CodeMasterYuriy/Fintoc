...
const features = [
  ...
  { label: "Control de gastos recurrentes", href: "#" },
  { label: "Saldos unificados", href: "#" },
  { label: "Presupuestos", href: "#" },
  { label: "Negociación de boletas", href: "#" },
]
const about = [
...
const Footer = () => {
  return (
    <footer className="bg-primary text-white rounded-t-[90px] pt-14 sm:pt-20 pb-9">
      ...
      <div className="max-w-5xl mx-auto px-10 grid grid-cols-1 sm:grid-cols-2 gap-8 text-center sm:text-left">
        <List
      ...
      <div className="max-w-5xl mx-auto px-10 mt-6 sm:mt-28 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="space-x-2 mt-6 md:mt-3">
          <img src={Logo_footer} alt="Gestiona Logo" className='w-48 sm:w-64'/>
        </div>
      </div>
